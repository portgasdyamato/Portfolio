      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-8">
          <motion.div
            ...
            className="inline-flex items-center justify-center w-16 h-16 bg-white/30 backdrop-blur-sm rounded-full mb-4 relative"
          >
          ...
          <motion.p
            ...
            className="text-gray-700 text-lg flex items-center justify-center gap-2"
          >
          ...
          {socialLinks.map((social, index) => {
            ...
            return (
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full flex h-24 items-center justify-between p-5 bg-white/40 backdrop-blur-sm rounded-2xl hover:bg-white/60 transition-all group/item shadow-sm border border-white/30 relative overflow-hidden "
              >
        ...
        >
          {[
            ...
            <motion.div
              ...
              className="p-4 bg-white/40 backdrop-blur-sm rounded-2xl shadow-sm border border-white/20 relative"
            >
        ...
        >
          ...
          <p className="text-gray-700 italic">"Great things happen when creative minds connect!" 🚀</p>
        </motion.div>
      </div>
    </motion.div>
  )
