...
export function FolderCard({ items, currentIndex, onNext, onPrev, direction = 'ltr', coverImage }: FolderCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div 
          className={`absolute inset-0 ${direction === 'rtl' ? 'rounded-l-2xl rounded-r-sm' : 'rounded-r-2xl rounded-l-sm'} shadow-2xl pointer-events-none border border-black/40 overflow-hidden bg-black`}
          style={{ transform: "translateZ(-10px)" }} 
        >
          <img src={coverImage || "/cover.png"} alt="Cover" className="absolute inset-0 w-full h-full object-cover opacity-80" />
          {/* Back cover vignette */}
        ...
        >
           ...
           <div 
             className={`absolute inset-0 bg-black ${direction === 'rtl' ? 'rounded-l-2xl rounded-r-sm shadow-[-5px_0_20px_rgba(0,0,0,0.6)] border-y border-l border-black/30 border-r-0' : 'rounded-r-2xl rounded-l-sm shadow-[5px_0_20px_rgba(0,0,0,0.6)] border-y border-r border-black/30 border-l-0'} flex flex-col overflow-hidden`}
             style={{ backfaceVisibility: "hidden" }}
           >
             <img src={coverImage || "/cover.png"} alt="Cover" className="absolute inset-0 w-full h-full object-cover z-0" />
           ...
           <div 
             className={`absolute inset-0 bg-black ${direction === 'rtl' ? 'rounded-l-2xl rounded-r-sm shadow-[inset_-10px_0_20px_rgba(0,0,0,0.8)] border-y border-l border-black/40 border-r-0' : 'rounded-r-2xl rounded-l-sm shadow-[inset_10px_0_20px_rgba(0,0,0,0.8)] border-y border-r border-black/40 border-l-0'} overflow-hidden`}
             style={{ backfaceVisibility: "hidden", transform: `rotateY(180deg) translateZ(1px)` }}
           >
             <img src={coverImage || "/cover.png"} alt="Cover Inside" className="absolute inset-0 w-full h-full object-cover opacity-60 z-0" />
