...
function ProjectCard({ project, offset, isActive, onProjectClick, onMove, spacing, index }: { 
  ...
  return (
    ...
    >
      <div className="absolute top-0 left-0 w-48 h-48 overflow-hidden pointer-events-none z-30 rounded-tl-[1.5rem] md:rounded-tl-[3.5rem]">
        <div className={`absolute top-12 -left-12 w-[175%] py-2 -rotate-45 text-center text-[9px] font-bold uppercase tracking-[0.25em] shadow-[0_5px_15px_rgba(0,0,0,0.3)] ${
