        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {certificates.map((cert, index) => (
            ...
            >
              ...
              <div className="flex justify-between items-start mb-10">
                ...
                {cert.certificateUrl && (
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    className="w-10 h-10 glass rounded-full flex items-center justify-center hover:bg-rose-600 hover:text-white transition-all"
                  >
              ...
              <h3 className="text-xl font-bold font-outfit mb-2 leading-tight uppercase group-hover:text-rose-600 dark:group-hover:text-rose-400 transition-colors">
                {cert.title}
              </h3>
