        ...
        <svg className="w-full h-full" viewBox="0 0 200 1400" preserveAspectRatio="none">
          <defs>
            <linearGradient id="pathGradient" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#FF7F7F" stopOpacity="0" />
              <stop offset="10%" stopColor="#FF7F7F" stopOpacity="1" />
              <stop offset="90%" stopColor="#FF7F7F" stopOpacity="1" />
  ...
  return (
    ...
    >
      <div className={cn(
        ...
        >
             {/* Center Core */}
             <div className="w-4 h-4 rounded-full bg-brand-600 shadow-[0_0_15px_rgba(255,127,127,0.8)] z-20" />
