    ...
    >
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-16 max-w-8xl h-full flex items-center relative">
          ...
          <div className="hidden lg:block absolute top-[10vh] bottom-[10vh] left-[60%] w-[1px] bg-[#1a0a0a]/[0.05] pointer-events-none" />

          <section className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-8 w-full h-full items-center py-12 pointer-events-auto">
