...
const educationJourney = [
  ...
  },
  {
    ...
    color: "#87CEEB",
    gpa: "82%",
    achievements: ["94% in Computer Science", "Made Projects", "Club Leader", "Enchanced Soft Skills"],
    description:
                ...
                >
                  ...
                  <motion.div className={`w-5/12 bg-[#FFD1D1] py-8 px-8 rounded-xl ${isLeft ? "pr-8" : "pl-8"}`}>
                    <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                      ...
                      {/* Institution */}
                      <p className="text-lg font-semibold text-purple-600 mb-3">{item.institution}</p>

                      {/* GPA/Percentage */}
                      <div className="flex justify-between items-center mb-4">
                        <span className="text-sm font-medium text-gray-500">Score:</span>
                        <span className="font-bold text-gray-700">{item.gpa}</span>
                      </div>
        ...
        {selectedItem !== null && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-3xl p-5 max-w-md w-full mx-4 shadow-2xl relative"
            ...
            >
              ...
              <div className="space-y-3">
                ...
                {educationJourney[selectedItem].achievements.map((achievement, i) => (
                  <motion.div
                    key={achievement}
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl text-center">
                ...
                <p className="text-2xl font-bold text-gray-800">{educationJourney[selectedItem].gpa}</p>
              </div>
            </motion.div>
          </motion.div>
        )}
