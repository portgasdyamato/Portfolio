            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between border-t border-border/50 pt-8 mt-auto">
                  <span className={`text-xl font-black font-outfit bg-clip-text text-transparent bg-gradient-to-r ${item.color}`}>
                    {item.gpa}
                  </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                ...
                <div className="flex flex-col">
                  <div className="px-8 py-6 glass rounded-[2rem] border-purple-500/20 mb-10">
                    ...
                    <span className={`text-4xl font-black font-outfit bg-clip-text text-transparent bg-gradient-to-r ${educationJourney[selected].color}`}>
