        ...
        {project.heroTemplate === 3 ? (
          ...
          <div className="w-full h-screen relative flex items-center bg-[#fafafa] dark:bg-[#0a0a0a] overflow-hidden">
             ...
             <div className="max-w-screen-2xl mx-auto w-full px-8 md:px-16 lg:px-20 flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10 pt-20 lg:pt-0">
                ...
                >
                   ...
                   <h1 className="text-[38px] md:text-[60px] lg:text-[72px] font-bold italic tracking-tighter leading-[0.95] mb-6">
                      {project.title}
                   </h1>
          ...
          <div className="w-full h-screen relative flex items-center bg-[#ffffff] dark:bg-[#000000] overflow-hidden px-8 md:px-16 lg:px-24">
             ...
             <div className="max-w-screen-2xl mx-auto w-full px-8 md:px-16 lg:px-20 flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10 pt-20 lg:pt-0">
                ...
                >
                   <div className="h-0.5 w-12 bg-brand-500 mb-8" />
                   <h1 className="text-[40px] md:text-[64px] lg:text-[76px] font-bold italic tracking-tighter leading-[0.95] mb-10">
                      {project.title}
                   </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-start">
            ...
            <div className="lg:col-span-5 space-y-16">
              <div className="flex flex-col gap-4">
                 ...
                 <h4 className="text-[42px] font-bold italic tracking-tighter text-foreground leading-[0.9]">
                  ...
                  {(research.methods.length > 0 ? research.methods : ["User Surveys", "Hotjar Analysis", "A/B Testing", "Focus Groups"]).map((method: string, i: number) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-1.5 mt-4">
                         ...
                         <h5 className="text-[18px] md:text-[20px] font-bold italic tracking-tighter text-foreground group-hover:text-brand-500 transition-colors duration-500">{method}</h5>
                      </div>
        ...
        <div className="max-w-screen-2xl mx-auto px-8 md:px-16 lg:px-20">
           <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
              <div className="w-full lg:w-[40%]">
                 ...
                 <h2 className="text-[40px] md:text-[60px] font-bold italic leading-[1.05] tracking-tight mb-8">
              ...
              <div className="flex flex-col gap-10">
                <div>
                   ...
                   <div className="space-y-4">
                      <p className="text-4xl font-bold italic tracking-tighter">{vi.typography.split('&')[0]}</p>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              <div>
                ...
                >
                  ...
                  <h2 className="text-[40px] md:text-[70px] font-bold italic leading-[1.05] tracking-tight mb-8">
      ...
      <section className="pt-52 pb-12 relative overflow-hidden">
        ...
        <div className="max-w-screen-2xl mx-auto px-8 md:px-16 lg:px-20 relative z-10 flex flex-col items-center text-center">
           <motion.div
             ...
             className="mb-24"
           >
              <h2 className="text-[50px] md:text-[90px] font-bold italic leading-tight mb-12">
...
function SectionHeader({ tag, title, icon: Icon }: { tag: string, title: any, icon: LucideIcon }) {
  return (
    ...
    >
      ...
      <h2 className="text-[40px] md:text-[60px] font-bold italic leading-tight text-[#1a0a0a] dark:text-white">
        {title}
      </h2>
    </motion.div>
  )
